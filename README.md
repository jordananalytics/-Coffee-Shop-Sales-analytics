...
Overall revenue performance remains positive, with sales revenue increasing **6.3% month-over-month**. However, the **32.8% decline in weekly orders** is a notable short-term concern. Meanwhile, AOV remained virtually unchanged, indicating that recent performance movement is primarily associated with changes in order volume rather than a significant change in spending per order.
